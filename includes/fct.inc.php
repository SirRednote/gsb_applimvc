...
/**	
 * Fonction qui retourne le mois précédent selon un mois passé en paramètre	
 *	
...
function getDouzeDerniersMois($mois)
{
    ...
    for($k=0;$k<12;$k++){	
        ...
        $numAnnee = substr($mois, 0, 4);	
        $numMois = substr($mois, 4, 2);	
        $lesMois[]=array('mois'=>$mois, 'numMois'=>$numMois, 'numAnnee'=>$numAnnee);
    }
    return $lesMois;
}
